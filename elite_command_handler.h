...
static char commands[NUM_COMMANDS][MAX_LEN] =
	{
		...
		"inv", "store", "use", "shipyard", "compareship", "buyship", "upgrade"};
...
static bool (*comfuncs[NUM_COMMANDS])(char *) =
	{
		...
		do_inventory_display, do_store_equipment, do_equip_from_inventory, do_shipyard, do_compareship, do_buyship, do_upgrade};
